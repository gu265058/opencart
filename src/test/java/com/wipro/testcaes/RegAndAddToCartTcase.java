...
import com.wipro.openCartPOM.Mobile_Samsung_GalaxyPage;
...
//'**********************************************************
//'* Method/TC_Name			: RegAndAddToCartTcase
//'* Method  Description	: This method will help in initializing the browser and launch the application
//'* Created By				: gu265058
...
public class RegAndAddToCartTcase {
	...
	HomePage homePage;
	Mobile_Samsung_GalaxyPage galaxyPage;
	...
	//'**********************************************************
		...
		public Object[][] inputDataValues() throws Exception{
			...
			ExcelSheet excelData = new ExcelSheet("E:/Assignments/exceldata/OpenCart.xlsx",0);
