...
public class Mobile_Samsung_GalaxyPage {
	...
	WebElement close;
	public Mobile_Samsung_GalaxyPage(WebDriver driver) {
		this.driver=driver;
		PageFactory.initElements(driver, this);
	}
	public Mobile_Samsung_GalaxyPage productreview(String reviewerName,String reviewComments,String rating){
		reviewTab.click();
